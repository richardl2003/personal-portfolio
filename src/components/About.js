            ...
            <div className="container about__container">
                ...
                <div className='about__content'>
                    ...
                    <p className='lead text-left'>
                        ...
                        research assistant at McMaster University investigating merge conflicts in Git. You can view a poster on my work <a href='https://drive.google.com/file/d/1S4VcQcO3BuCY1cKwBrjBvTJ8yrBD6efq/view?usp=sharing'>here</a>.
                    </p>
                    <p className='lead text-left'>
